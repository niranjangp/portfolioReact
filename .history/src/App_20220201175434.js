    ...
    <div className='App'>
      <div className="containerOne">
        <nav className='navigation'>
          ...
          <div className='navDiv'>
            <NavLink activeClassName="nav-link active" className="nav-link" to="/cs-one">Case Study Numero const first = useContext(second);</NavLink>
          </div>
          <div className='navDiv'>
        ...
        <footer>
          ...
          <div className='credits'>
            ...
            <a href="https://www.flaticon.com/free-icons/digital-money" title="digital money icons">Digital money icons created by Freepik - Flaticon</a>
          </div>
        </footer>
      </div>
