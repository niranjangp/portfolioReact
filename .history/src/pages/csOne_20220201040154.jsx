    ...
    <div className='csOne'>
      ...
      <div className='csOneBody'>
        ...
        <div className="pd-bt">
          ...
          <p className="csOneC"><p className='fir clrp'></p><span> : #0070d2</span></p>
          <p className="csOneC"><p className='sec clrp'></p><span> : #16325C</span></p>
          <p className="csOneC"><p className='thi clrp'></p><span> : #00437D</span></p>
