    ...
    <div className='csOne'>
      ...
      <div className='csOneBody'>
        ...
        <div className="pd-bt">
          ...
          <p className="csOneC">Responsive design accomodating Desktop, Tablet and Mobile versions of the webpage.</p>
          <div><img src={MrDesk} alt="mr-screen" className='mrDesk' /><div>Desktop (Large) screen</div></div>
          <div><div>Tablet (Medium) screen</div><img src={MrTab} alt="mr-screen" className='mrTab' /></div>
          <div><img src={MrMob} alt="mr-screen" className='mrMob' /><div>Mobile (Small) screen</div></div>
        </div>
      </div>
    </div>
  )
