...
const csThree = () => {
    return (
        <div className='cs3'>
            ...
            <div className='cs3Header'>Expense App!!!</div>
            <div className="exp-body">
                <div className="right-content">
                    <p className="exp-para">The Expense Tracker we all need.</p>
                    <p className="exp-para">One App to calculate yearly expenditure on products and commodities.</p>
                ...
                <div>
                    ...
                    <div className="flexExp"><div className="iconText">This screen displays the scenario when there is only one Expense entry for a particular month, it captures the when, how much, and the monthly chart of the expenses.</div><img src={SingleExp} alt="single-exp" className="expIcon" /></div>
                    <div className="flexExp"><div className="iconText">This screen displays the scenario when multiple expense items are entered, with the highest amount in a particular month being accounted for in a year to be the highest amount in the chart, unless overwritten by any future expenses exceeding the previous highest amount. The subsequent monthly expense details captured are based on the highest month and fill the chart appropriately.</div><img src={MultiExp} alt="multi-exp" className="expIcon" /></div>
                </div>
                <div className="right-content last">
                    ...
                    <p className="exp-para">The known in this story is the tracking model, and the unknown could be the integration of payment methods to track or update live status.</p>
                    <p className="exp-para">Further development on the tracking and payment integration will help enhance the interface and experience of the app.</p>
