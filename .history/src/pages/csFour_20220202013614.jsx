    ...
    return (
        <div className="cs4">
            ...
            <div className="quo-body">
                ...
                <div className="mrg-blk">
                    <div clasName="quo-pack"><img src={QuoHome} alt="quote-home" className="quoIcon" /><div className="qIconTxt">Home of the quotes</div></div>
                    <div clasName="quo-pack"><img src={AddQuo} alt="quote-home" className="quoIcon" /><div className="qIconTxt">The Add quote page</div></div>
                    <div clasName="quo-pack"><img src={CommonScen} alt="quote-home" className="quoIcon"/><div className="qIconTxt">Add Comment Scenario</div></div>
                </div>
                <div className="mrg-blk">
