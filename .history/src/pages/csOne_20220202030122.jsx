...
const csOne = () => {
  return (
    <div className='csOne'>
      ...
      <div className='csOneHeader'>A Portal for a Mandated Reporter</div>
      <div className='csOneBody'>
        <div className="pd-bt">
          <p className="csOneH">The START -</p>
          <p className="csOneC">This turned out to be the first opportunity in my design roadmap.</p>
        ...
        <div className="pd-bt">
        <p className="csOneH">Summary</p>
        <p className="summaryOne">Developing a portal to address and respond as per the requirement of the business model is the main idea for this design.</p>
        <p className="summaryOne">The requirements were simple and candid which helped formulate the initial draft, but better understanding of the target audience would help design user-centric solutions with involvement of persona and research-driven techniques.</p>
        <p className="summaryOne">Takeaway - Understood the roles of persona-driven, user-centric and research driven design thinking to help develop a quality end product.</p>
        </div>
      </div>
