        ...
        <div className='cs3'>
            ...
            <div className="exp-body">
                ...
                <div>
                    ...
                    <div className="flexExp"><div className="iconText">The Home Page of the Expense app to view add and view expense details.</div><img src={ExpHome} alt="expense-home" className="expIcon"/></div>
