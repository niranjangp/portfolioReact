    ...
    <div className='App'>
      <div className="containerOne">
        <nav className='navigation'>
          <ul>
            <li>
              <NavLink activeClassName='linkSel' to="/cs-one">One Case Study</NavLink>
            </li>
            <li>
              <NavLink activeClassName='linkSel' to="/cs-two">Case 2 Study</NavLink>
            </li>
            <li>
              <NavLink activeClassName='linkSel' to="/cs-three">Case Study the III</NavLink>
            </li>
            <li>
              <NavLink activeClassName='linkSel' to="/cs-three">Case Study the III</NavLink>
            </li>
        ...
        <main className='mainOne'>
          <Routes>
            <Route exact path="/" element={<EnterTheDesign />}></Route>
